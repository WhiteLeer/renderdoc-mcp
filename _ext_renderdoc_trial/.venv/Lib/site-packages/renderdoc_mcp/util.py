...
def load_renderdoc():
    """Load the renderdoc Python module.
    
    The module and DLLs are loaded from the bundled lib/ directory,
    which is configured in __init__.py during package initialization.
    """
